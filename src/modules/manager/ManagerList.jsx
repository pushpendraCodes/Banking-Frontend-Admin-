  ...
  return (
    <div className="">
      <div className="flex justify-between items-center mb-4">
        ...
        <Link to="/managers/add" className="bg-yellow-400 hover:bg-yellow-500 text-white px-4 py-2 rounded">
          Add Manager
        </Link>
      </div>
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <button className="ml-auto flex items-center gap-1 text-sm border border-yellow-400 text-yellow-600 px-3 py-1 rounded hover:bg-yellow-100">
         ...
         <span className="hidden md:block lg:block"> Sort By</span>
        </button>
      </div>
              ...
              <tr key={cust.id} className="odd:bg-white even:bg-yellow-50">
                ...
                <td className="px-4 py-2 border">
                  <div className="flex gap-2">
                    <Link to="/managers/view-edit/1" className="bg-yellow-400 hover:bg-yellow-500 text-white p-2 rounded">
                      <FaEye size={14} />
                    </Link>
