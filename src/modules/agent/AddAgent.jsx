          ...
          <div className="p-8 grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-3 border ${
                  errors.AadharNo ? "border-red-400" : "border-gray-200 focus:border-yellow-400"
                } rounded-lg bg-gray-50 outline-none duration-200`}
              />
              {errors.AadharNo && (
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-3 border ${
                  errors.panCard ? "border-red-400" : "border-gray-200 focus:border-yellow-400"
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-3 border ${
                  errors.signature ? "border-red-400" : "border-gray-200 focus:border-yellow-400"
                } rounded-lg bg-gray-50 outline-none duration-200`}
              />
              {errors.signature && (
            ...
            <div>
              ...
              <select
                ...
                className={`w-full p-3 border ${
                  errors.gender ? "border-red-400" : "border-gray-200 focus:border-yellow-400"
                } rounded-lg bg-gray-50 outline-none duration-200`}
              >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className={`w-full p-3 border ${
                    errors?.NomineeDetails?.name ? "border-red-400" : "border-gray-200 focus:border-yellow-400"
                  } rounded-lg bg-gray-50 outline-none duration-200`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full p-3 border ${
                    errors?.NomineeDetails?.age ? "border-red-400" : "border-gray-200 focus:border-yellow-400"
                  } rounded-lg bg-gray-50 outline-none duration-200`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full p-3 border ${
                    errors?.NomineeDetails?.dob ? "border-red-400" : "border-gray-200 focus:border-yellow-400"
                  } rounded-lg bg-gray-50 outline-none duration-200`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Enter Email Address"
                  className={`w-full p-3 border ${
                    errors?.NomineeDetails?.email ? "border-red-400" : "border-gray-200 focus:border-yellow-400"
                  } rounded-lg bg-gray-50 outline-none duration-200`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full p-3 border ${
                    errors?.NomineeDetails?.mobile ? "border-red-400" : "border-gray-200 focus:border-yellow-400"
                  } rounded-lg bg-gray-50 outline-none duration-200`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full p-3 border ${
                    errors?.NomineeDetails?.AadharNo ? "border-red-400" : "border-gray-200 focus:border-yellow-400"
                  } rounded-lg bg-gray-50 outline-none duration-200`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Enter PAN Card Number"
                  className={`w-full p-3 border ${
                    errors?.NomineeDetails?.panCard ? "border-red-400" : "border-gray-200 focus:border-yellow-400"
                  } rounded-lg bg-gray-50 outline-none duration-200 uppercase`}
                />
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  placeholder="Enter Complete Address"
                  className={`w-full p-3 border ${
                    errors?.NomineeDetails?.address ? "border-red-400" : "border-gray-200 focus:border-yellow-400"
