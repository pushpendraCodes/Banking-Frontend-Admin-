...
const Header = () => {
  ...
  return (
    <header className="bg-[#fef7ef] z-50  drop-shadow-sm py-3 px-4 flex flex-wrap md:flex-nowrap justify-between items-center gap-2">
      ...
      <img src="/LOGOIMAGE.png" alt="profile image" />
      </Link>
      </div>
